...
player_items = [{'item': potion, 'quantity': 15}, {'item': hipotion, 'quantity': 5},
                {'item': superpotion, 'quantity': 5}, {'item': potion, 'quantity': 5},
                {'item': elixer, 'quantity': 5}, {'item': hielixer, 'quantity': 5},
                {'item': grenade, 'quantity': 5}]

# Instantiate People
player1 = Person('Valos:', 3460, 132, 300, 34, player_spells, player_items)
    ...
    for enemy in enemies:
        ...
        if enemy_choice == 0:
            ...
            if spell.type == 'white':
                ...
                print(bcolors.OKBLUE + spell.name + ' heals ' + enemy.name + 'for', str(magic_dmg), 'MP' + bcolors.ENDC)
            elif spell.type == 'black':
